...
static void
acaller (char *caller, char *file, int x, int y, int count,
         struct func *callee)
{
  struct caller *q;
...
static struct func *
afunction (char *name, char *file, int x, int y, int count)
{
...
static void
apoint (int i, char *file, int x, int y, int count)
{
  struct file *p = findfile (file);
...
int
findcount (char *file, int x, int y)
{
